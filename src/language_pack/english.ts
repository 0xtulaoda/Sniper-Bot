const lang = {
  ...
  TODAY_OR_TOMORROW:
    'The bot will snipe at the given time today. Do you want to set it to snipe tomorrow instead? (y/n): ',
  BLOCK_QUERY_ERR: 'Error occurred quering the block',
  EOR: 'End of error',
  SHOULD_NOT_INTERFER:
    'NOTE: If the error occurs occasionally the bot should still continue running smoothly',
};
export default { lang };
