...
bot_init.delayConfig().then(() => {
  ...
  bot_init.walletConfig().then(async () => {
    ...
    if (bot_init.mode.get('presale')) {
      ...
      var presale_bot: PresaleBot = new PresaleBot(
        bot_init.mode.get('testnet') as boolean,
      ...
      console.log(
        '\n\x1b[36m' +
          language.lang.WILL_ASK_TIME +
          '\x1b[1m\x1b[4m' +
          language.lang.LOCAL_TIME +
          '\x1b[0m.\x1b[0m',
      );
      ...
      console.log(
        '\x1b[33m' +
          language.lang.START_TIME_SET +
          '%d:%d \x1b[1m\x1b[4m' +
          language.lang.LOCAL_TIME +
          '\x1b[0m.\x1b[0m',
        trigger_time.getHours(),
        trigger_time.getMinutes(),
      );
